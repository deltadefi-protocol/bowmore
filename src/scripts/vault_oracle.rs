...
pub fn vault_oracle_mint_blueprint() -> MintingBlueprint {
...
pub fn vault_oracle_spend_blueprint() -> SpendingBlueprint {
...
mod tests {
    ...
    fn test_vault_oracle_mint_blueprint() {
        ...
        let blueprint = vault_oracle_mint_blueprint();
    ...
    fn test_vault_oracle_spend_blueprint() {
        ...
        let blueprint = vault_oracle_spend_blueprint();
        assert_eq!(blueprint.hash, "TODO");
        assert_eq!(blueprint.cbor, "TODO");
    }
}
